...
## 🔭 Ronda de vigilancia 2026-07 (2ª pasada) — ejecutada 2026-07-24

> Metodología: `docs/VIGILANCIA-NORMATIVA.md` (v1.0). Corrida a mitad de ciclo (la 1ª pasada de 2026-07 fue el 2026-07-09). **Cobertura: 11/11 jurisdicciones con respuesta explícita.** Fecha de consulta de todas las fuentes: **2026-07-24**.
>
> **Escalamiento §8 — SIN 🔴 URGENTE esta ronda.** Ningún mecanismo de transferencia cayó (DPF UE-USA sigue vigente; Brasil *ganó* adecuación UE — aditivo); ninguna autoridad competente cambió; ninguna entrada en vigencia ≤45 días dentro del alcance central del repo. Único ≤45 días detectado: registro de *data brokers* de California (01-ago-2026), de nicho y fuera del alcance general del repo — se anota como *heads-up*, no como 🔴.

| Jurisdicción | Hallazgo | Clase | Fuente(s) · fecha consulta 2026-07-24 | Impacto en repo / acción |
|---|---|---|---|---|
| 🇧🇷 Brasil | **Resolução CD/ANPD nº 32, de 26-01-2026**: reconoce a la **Unión Europea** como organismo internacional con nivel de protección adecuado (Art. 33 LGPD) para transferencias internacionales. Vigente. | ✅ CONFIRMADO | [gov.br/ANPD — Regulamentações](https://www.gov.br/anpd/pt-br/acesso-a-informacao/institucional/atos-normativos/regulamentacoes_anpd) · [DOU Res. 32](https://www.in.gov.br/web/dou/-/resolucao-n-32-de-26-de-janeiro-de-2026-683334547) | `brasil.json` → `international_transfer`: añadir adecuación UE como mecanismo. Ticket editorial. |
| 🇧🇷 Brasil | Res. CD/ANPD nº 31 (22-12-2025, altera Agenda Regulatória 2025-2026) y nº 30 (23-12-2025, Mapa de Temas Prioritários 2026-2027). Nota Técnica nº 1/2026: output de IA generativa puede ser dato personal. | ✅ CONFIRMADO (30/31) · ⚪ MONITOREO (NT 1/2026) | [gov.br/ANPD](https://www.gov.br/anpd/pt-br/acesso-a-informacao/institucional/atos-normativos/regulamentacoes_anpd) · [IAPP — NT 1/2026](https://iapp.org/news/a/ia-generativa-y-protecci-n-de-datos-en-brasil-posicionamiento-de-la-anpd-en-la-nota-t-cnica-n-1-2026) | Contexto regulatorio; sin impacto directo en reglas. IA generativa → backlog. |
| 🇨🇴 Colombia | **Ley Estatutaria 2573 de 2026** (promulgada 19-05-2026, **Diario Oficial 53496 del 20-05-2026**): desarrolla habeas data, intimidad y buen nombre frente a la **suplantación de identidad digital**; obligaciones a operadores de telecomunicaciones, entidades financieras/crediticias y comercios de crédito. **Régimen general en vigor ~19-11-2026** (6 meses tras promulgación). | ✅ CONFIRMADO | [DAPRE — texto oficial (PDF)](https://dapre.presidencia.gov.co/normativa/normativa/LEY%20No.%202573%20DEL%2019%20DE%20MAYO%20DE%202026.pdf) · [Alcaldía de Bogotá — sisjur](https://www.alcaldiabogota.gov.co/sisjur/normas/Norma1.jsp?dt=S&i=193210) | **Resuelve el flag de la ronda anterior** ("verificar Ley 2573/2026"). `colombia.json` → régimen adyacente de identidad/habeas data + KYC. Vigilar vigencia nov-2026 (checklist ⑥). |
| 🇨🇴 Colombia | Proyecto de Resolución SIC (modifica Título V Circular Única — habeas data financiero, RNBD, alineación a Leyes 2157/2021 y 2573/2026): **comentarios cerrados 10-06-2026, sin resolución final localizada**. | ⚪ MONITOREO | [SIC — Sede Electrónica (proyecto)](https://sedeelectronica.sic.gov.co/transparencia/normativa/proyecto-de-resolucion-por-la-cual-se-modifica-el-titulo-v-de-la-circular-unica-de-la-superintendencia-de-industria-y) | Es PROYECTO — prohibido registrar como vigente. Re-verificar en ronda 2026-08 (texto final). |
| 🇵🇪 Perú | **Resolución Directoral N.° 100-2025-JUS/DGTAIPD** (El Peruano 31-12-2025): Directiva de designación, desempeño y funciones del **Oficial de Datos Personales (ODP)** + **nueva metodología de cálculo de multas**. | ✅ CONFIRMADO | [gob.pe/ANPD — RD 100-2025](https://www.gob.pe/institucion/anpd/normas-legales/7574631-100-2025-jus-dgtaipd) · [MINJUSDH — noticia](https://www.gob.pe/institucion/minjus/noticias/1324603-minjusdh-refuerza-la-proteccion-de-datos-personales-con-nueva-directiva-y-metodologia-de-calculo-de-multas) | Complementa el D.S. 016-2024-JUS. Insumo para el pendiente de migrar referencias al reglamento 2024. Cobertura Perú → ODP + sanciones. |
| 🇪🇨 Ecuador | **Ola de resoluciones SPDP 2026**: **0009-R** (12-02-2026, norma general de datos en uso de **IA**), **0004-R** (transferencias nacionales e internacionales), **0005-R** (tratamiento a gran escala), **0003-R** (actividades domésticas/familiares). Enforcement: sanción a LIGAPRO (app FAN ID). | ✅ CONFIRMADO | [SPDP — Resoluciones](https://spdp.gob.ec/resoluciones2/) · [Lexis EC — norma IA](https://www.lexis.com.ec/noticias/superintendencia-de-proteccion-de-datos-personales-expide-norma-general-para-la-proteccion-de-datos-personales-en-el-uso-de-inteligencia-artificial) | Insumo sustantivo para el futuro `ecuador.json` (Ola 3). Proyectos en consulta (datos biométricos; vulneraciones) → ⚪ MONITOREO. |
| 🇵🇦 Panamá | **Circular ANTAI DS-002-2026** — *"Cumplimiento de obligaciones en materia de Protección de Datos Personales"* (publicada abr-2026, vista en el sitio oficial de ANTAI). | ✅ CONFIRMADO | [ANTAI — Legislación](https://antai.gob.pa/legislacion/) · [PDF Circular DS-002-2026](https://antai.gob.pa/wp-content/uploads/2026/04/Circular-DS-002-2026.pdf) | Insumo para futuro `panama.json`. Editor: revisar contenido sustantivo del PDF. |
| 🇵🇦 Panamá | **Resolución ANTAI-DG-003-2026** (26-03-2026): adopta las Cláusulas Contractuales Estándar de la RIPD para transferencias internacionales. Texto oficial **aún no visto directamente** (no figura en la lista de Resoluciones de antai.gob.pa; buscar en Gaceta Oficial). | 🟡 PROBABLE | [Morgan & Morgan](https://morimor.com/panama-updates-rules-for-international-data-transfers/) · [Beccar Varela](https://beccarvarela.com/en/novedades/30435-2/) · [EY](https://www.ey.com/es_ar/technical/law/ey-law-alerts-argentina/datos-personales-aprobacion-clausulas-contractuales-modelo) · registros del Órgano Judicial (pub. referida 26-06-2026) | **Avanza el pendiente heredado** (ahora con referencia de publicación). Localizar PDF oficial en Gaceta ≤7 días. Futuro `panama.json` → mecanismo de transferencia. |
| 🇪🇺 UE | **EDPB**: adopta guidelines sobre interplay **DSA↔GDPR** y versión final sobre **blockchain**; guidelines sobre datos para investigación científica (abr-2026). **Consulta pública 07-07-2026**: **Guidelines 02/2026 (Anonimización)** y **03/2026 (web scraping para IA generativa)**. | ✅ CONFIRMADO (adoptadas) · ⚪ MONITOREO (en consulta) | [EDPB — anonimización + web scraping](https://www.edpb.europa.eu/news/edpb-sheds-light-on-anonymisation-and-web-scraping-for-generative-ai-and-adopts-final-version_en) · [EDPB — DSA/GDPR](https://www.edpb.europa.eu/news/interplay-between-the-dsa-and-the-gdpr-edpb-adopts-guidelines_en) | Muy relevante para devs/IA. Backlog `gdpr.json`: capa IA / anonimización / web scraping. |
| 🇪🇺 UE | **DPF UE-USA**: apelación **C-703/25 P** (Latombe) ante el TJUE **sigue pendiente, sin fallo** a jul-2026. DPF vigente. | ⚪ MONITOREO | [IAPP — Latombe/DPF](https://iapp.org/news/a/european-general-court-dismisses-latombe-challenge-upholds-eu-us-data-privacy-framework) | **Sin caída de mecanismo → sin escalamiento.** Mantener SCCs como contingencia documentada. Vigilar cada ronda. |
| 🇺🇸 USA estados | El conteo de leyes integrales de privacidad **pasó de 19 (ene-2026) a ~20** en 2026; vigencias 2026: IN/KY/RI (01-ene, ya registradas), enmiendas de Connecticut y otras el 01-07-2026. | 🟡 PROBABLE | [IAPP — nuevas reglas 2026](https://iapp.org/news/a/new-year-new-rules-us-state-privacy-requirements-coming-online-as-2026-begins) · [MultiState](https://www.multistate.us/insider/2026/2/4/all-of-the-comprehensive-privacy-laws-that-take-effect-in-2026) · [IAPP tracker](https://iapp.org/resources/article/us-state-privacy-legislation-tracker) | `state-matrix.json`: actualizar conteo (19→20) y verificar contra el IAPP tracker qué ley elevó el total. |
| 🇺🇸 USA federal | Sin novedades sustantivas confirmadas en regulaciones CPPA esta ronda. **Registro de *data brokers* de California (DELETE/DROP Act) vigente 01-08-2026** (nicho *data brokers*). | ⚪ MONITOREO | [IAPP — nuevas reglas 2026](https://iapp.org/news/a/new-year-new-rules-us-state-privacy-requirements-coming-online-as-2026-begins) | Sin cambios en `usa-federal.json`. Verificar regs CPPA 2026 (ADMT/risk assessment/cyber audit) en próxima ronda. |
| 🇲🇽 México | Sin novedades sustantivas. LFPDPPP 2025 vigente; **Reglamento aún no publicado** (pendiente); SABG operativa (Padrón de Sujetos Obligados, oct-2025). | ✅ Verificado (sin cambios de reglas) | [EY México](https://www.ey.com/es_mx/technical/tax/boletines-fiscales/nueva-ley-federal-proteccion-datos-personal-posesion-particulares) · [SABG — Padrón](https://www.gob.mx/cms/uploads/attachment/file/1025983/2025_10_01_MAT_sabg_-_Padr_n_de_Sujetos_Obligados_en_materia_de_protecci_n_de_datos_personales.pdf) | Sin cambios en `mexico.json`. Vigilar publicación del **Reglamento** (afecta plazo de notificación de vulneraciones a la autoridad). |
| 🇨🇱 Chile | **APDP aún sin instrucciones generales publicadas**; ventana jun-nov 2026 abierta; potestad sancionatoria plena desde 01-12-2026 (~130 días). Sin cambios vs. ronda anterior. | ⚪ MONITOREO (**PRIORIDAD MÁXIMA**) | [Garrigues](https://www.garrigues.com/es_ES/noticia/chile-comision-ministerial-implementacion-ley-proteccion-datos-recomienda-anticipar) · [Secretaría de Gobierno Digital — Guía](https://wikiguias.digital.gob.cl/datos-personales/guia-practica-implementacion-nueva-ley-datos-personales) | Sin cambio de reglas. Recomendación: **añadir URL oficial de la APDP a las fuentes ancla §2**; mantener vigilancia frecuente hasta 01-12-2026. |
| 🇦🇷 Argentina | Ley 25.326 vigente **sin reforma aprobada**. Proyectos en Congreso: Carro, Doñate y **Yeza (1751-D-2026, 72 arts.)**, todos alineados a RGPD/LGPD. | ⚪ MONITOREO | [IAPP — nuevo proyecto AR](https://iapp.org/news/a/se-impulsa-un-nuevo-proyecto-de-reforma-del-r-gimen-de-protecci-n-de-datos-en-argentina) · [AAIP](https://www.argentina.gob.ar/noticias/la-aaip-presento-el-proyecto-de-actualizacion-de-la-ley-de-proteccion-de-datos-personales) | Sin cambio de reglas (los proyectos NUNCA se registran como norma vigente — caso de escuela). |

**Cobertura explícita 11/11:** 🇲🇽 (sin novedades sustantivas) · 🇧🇷 (Res. 32/2026 + 30/31) · 🇨🇴 (Ley 2573/2026) · 🇨🇱 (sin cambios — máxima prioridad) · 🇦🇷 (solo proyectos) · 🇵🇪 (RD 100-2025) · 🇪🇨 (ola SPDP 2026) · 🇵🇦 (Circular DS-002-2026 + DG-003-2026) · 🇺🇸 federal (sin novedades) · 🇺🇸 estados (19→20) · 🇪🇺 (EDPB + DPF pendiente).

**Pendientes heredados — estado:** (i) *ANTAI-DG-003-2026* → avanzó a 🟡 con referencia de publicación (Gaceta/Órgano Judicial); falta localizar el PDF oficial. (ii) *Proyecto de resolución SIC (Título V)* → comentarios cerrados 10-06-2026, sin texto final publicado; seguir. (iii) *Instrucciones APDP Chile* → aún no publicadas; seguir (prioridad máxima).

**Nuevos pendientes para la ronda 2026-08:** texto oficial de ANTAI-DG-003-2026; resolución final SIC del Título V; instrucciones generales de la APDP Chile; qué ley elevó el conteo de estados USA a ~20 + regs CPPA 2026; versión final de las Guidelines EDPB 02/2026 (anonimización) y 03/2026 (web scraping IA). **Sugerencia de fuentes ancla (§2):** añadir el sitio oficial de la **APDP de Chile** y de la **SPDP de Ecuador (spdp.gob.ec)**; para Panamá, añadir la **Gaceta Oficial** + la página *Legislación* de ANTAI.

*Registro append-only. La IA propone; el editor humano decide y edita `cli/rules/`; el abogado revisor valida y promueve `review_status`. No constituye asesoría jurídica — ver `DISCLAIMER.md`.*
